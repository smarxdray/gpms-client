<template>
  <div class="app-container">
    <el-button type="primary" @click="handleAddRole">{{ $t('permission.addAccount') }}</el-button>
    <el-table :data="userList" style="width: 100%;margin-top:30px;" border>
      ...
      <el-table-column width="100px" label="Role">
        <template slot-scope="scope">
          <span v-for="n in scope.row.roles" :key="n" v-html="n"/>
        </template>
      </el-table-column>
      ...
      <!-- <el-table-column min-width="300px" label="E-mail">
        <template slot-scope="scope">
    ...
    <el-dialog :visible.sync="dialogVisible" :title="dialogType==='edit'?'Edit Role':'New Role'">
      <el-form :model="role" label-width="80px" label-position="left">
        ...
        <el-select v-model="status" placeholder="请选择账户状态">
            <el-option
